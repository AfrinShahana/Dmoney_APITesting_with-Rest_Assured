...
public class User extends Setup {
    ...
    public void LoginAPIWithInvalidinfo() {
    ...
    public void LoginAPIWithValidinfo() throws ConfigurationException {
        RestAssured.baseURI = prop.getProperty("base_url");
        Response res =
                given()
                        .contentType("application/json")
    ...
    public void SearchUserByInvalidPhonenumber() throws ConfigurationException, IOException {
        ...
        Response res =
                given()
                        ...
                        .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                        .when()
                        .get("/user/search/phonenumber/01583111111");
    ...
    public void SearchingAgentByInvalidPhonenumber() throws ConfigurationException, IOException {
        ...
        Response res =
                given()
                        ...
                        .header("X-AUTH-SECRET-KEY", "ROADTOSDET")
                        .when()
                        .get("/user/search/phonenumber/01583155555");
